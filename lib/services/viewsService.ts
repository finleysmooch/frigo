...
// 8R-UX6 Item 3: previous rename override map removed. DB row's `name` is
// now authoritative — `seed_default_views()` emits the new names directly
// (Short / Medium / Long List + In Cart) and the row-migration migration
// renamed existing rows in place.
