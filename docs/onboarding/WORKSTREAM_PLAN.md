...
| CP-persist | migration + gate | mechanical | 🟢 **runnable now** (D-ON-10) | — |
| CP4-ext | service | mechanical | 🟢 **runnable now** (D-ON-12) | — |
...
| CP9a | T1–T4 | checkpoint | 🟢 unblocked (D-ON-10/15) | CP-persist |
| CP9b | T5 | checkpoint | scoped — cohort model (D-ON-11); ships without contacts | CP9a, CP7-minimal |
| CP9c | T6 | checkpoint | 🟡 sequenced | CP9a |
| CP9d | T7–T9 | checkpoint | 🟡 T8b out (OB-8); T9b degraded-or-flags call **reported at draft** | CP9c, CP4-ext |
