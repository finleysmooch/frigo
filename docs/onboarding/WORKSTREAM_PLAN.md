...
| CP9d | T7–T9 | checkpoint | ⏳ **authored + backend-verified 2026-06-12** (harness 5/5; tsc clean). Calls made: **T9b DEGRADED** (recipe+favorite, no backdated post); **T9c held** (no chef-follow mechanism exists — needs ruling). T9a live extraction owed from Tom's walk | Tom walk + commit |
