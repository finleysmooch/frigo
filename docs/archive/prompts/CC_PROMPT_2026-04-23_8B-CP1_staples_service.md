...
**Required:**
1. `docs/PHASE_8_PANTRY_INTELLIGENCE.md` v2.1 — sub-phase 8B section, specifically 8B-CP1. Read the "Architectural decisions" block under 8B (D8-7, D8-8, D8-9, D8-25).
2. `docs/phase_8_system_prototype_v5.html` (when available) — open the **Pantry tab**. Observe the staples grid behavior:
