...
**Primary reference:** `docs/wireframes/phase_8/phase_8_system_prototype_v5.html` when available (will be at that path after wireframe setup commit), **Pantry tab**.
...
**Required:**
1. `docs/planning/PHASE_8_PANTRY_INTELLIGENCE.md` v2.1 — 8B-CP2 section + architectural notes on staples UI.
2. `docs/wireframes/phase_8/phase_8_system_prototype_v5.html` (when available) — **Pantry tab**. Primary visual reference.
